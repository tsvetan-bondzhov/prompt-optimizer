...
default ``prepare_evaluation`` factory is registered under the same name so
...
from app.implementations.prepare import prepare_evaluation
...
register("evaluation_prepare", "ollama_mistral", prepare_evaluation)
